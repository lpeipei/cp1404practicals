...
def run_tests():
    ...
    # assert test for fuel using both the passed-in value and the default
...
# Function to format a phrase as a sentence
...
# Test the format_as_sentence function
print(format_as_sentence('hello'))
print(format_as_sentence('It is an ex parrot.'))
print(format_as_sentence('this is a test'))
